      ...
      <div className="parent">
            ...
            <p className="job-desc">
              <span>
                ...
                <p>
                  ...
                  personnes, en collaboration étroite avec d'autres départements
                  de l'entreprise.
                </p>
                <p>
        ...
        <div className="first-experience experience-container container">
          ...
          <div className="job">
            ...
            <p className="job-date">
              <span className="date">Avril 2022</span> -{' '}
              <span className="date">Juin 2022</span>
            </p>
            <p className="job-desc">
              <span>
                <p>
                  J'ai ajouté la fonctionnalité suivante au blog de l’entreprise
                  ITarverne déjà existant :
                </p>
                <p>
                  permettre le post automatique de promotion de l’article que
                  l’on poste sur le blog sur Twitter et LinkedIn,
                </p>
              ...
              <span>
                <p>
                  J'ai travaillé sur un second projet React. J'ai corrigé u n
                  chat en direct qui existait mais n'était plus fonctionnel.
                </p>
                <p>
                  J'ai aussi repris un autre projet avec la même stack
                  technique, qui permettait de rapporter des bugs à l'équipe de
                  maintenance du site.
                </p>
                <p>
                  J'ai relié ces deux projets, je les ai installés dans un
                  container Docker. Le chat est une application node.js,
                </p>
                <p>
                  qui utilise des sockets et écoute les requêtes envoyées par le
                  site.
                </p>
